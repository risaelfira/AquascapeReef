...
<header class="relative w-full h-[420px] bg-cover bg-center text-white flex items-center justify-center" style="background-image: url('karang.jpg');">
  ...
  <div class="relative z-10 text-center px-4">
    ...
    <p class="mt-4 text-lg italic drop-shadow-sm">Pulau Barrang Lompo, Sulawesi Selatan</p>
  </div>
</header>
...
<main class="pt-12 pb-20 px-4 max-w-5xl mx-auto">
  <div class="bg-white p-6 md:p-10 shadow-2xl rounded-xl border border-blue-100 animate-fadeIn">
    ...
    <p class="text-lg leading-relaxed text-justify mb-8">
      Kegiatan ini merupakan bagian dari <strong>Program Pengembangan Produk Unggulan Daerah (PPPUD)</strong> oleh tim dari <strong>Politeknik Pertanian Negeri Pangkep</strong>, bekerja sama dengan UKM Angin Mamiri dan UKM Rezky Bahari. Melalui metode fragmentasi karang, koloni indukan dicacah dan ditempelkan pada substrat buatan yang diletakkan di rak dasar laut ramah lingkungan.
    </p>
    ...
    <p class="text-lg leading-relaxed text-justify mb-8">
      Program ini berlangsung dari <strong>Mei hingga Oktober 2020</strong> di <strong>Pulau Barrang Lompo, Makassar</strong>. Kegiatan termasuk pelatihan teknik budidaya, pemeliharaan, hingga pengemasan karang hias. Evaluasi rutin dilakukan untuk menilai pertumbuhan dan manajemen usaha.
    </p>
    ...
    <p class="text-lg leading-relaxed text-justify mb-8">
      Program ini bertujuan menciptakan sumber penghasilan alternatif yang ramah lingkungan, mengurangi eksploitasi karang alam, serta memenuhi pasar ekspor. Selain itu, peningkatan kapasitas nelayan dalam agribisnis kelautan dan pariwisata turut menjadi fokus.
    </p>

    <div class="mb-6 rounded-md bg-gradient-to-r from-indigo-500 to-purple-400 px-4 py-3 shadow-md">
      <h2 class="text-white text-2xl font-bold tracking-wide">📍 Lokasi</h2>
    </div>
    <p class="text-lg leading-relaxed text-justify mb-6">
      Lokasi budidaya berada di <strong>perairan Pulau Barrang Lompo</strong> (Koordinat: <code>5°02'51.7"S 119°19'37.3"E</code>) yang memiliki visibilitas baik, substrat pasir, dan terlindung dari gelombang besar.
    </p>

    <div class="mb-6 rounded-md bg-gradient-to-r from-pink-500 to-red-400 px-4 py-3 shadow-md">
      <h2 class="text-white text-2xl font-bold tracking-wide">🌟 Dampak Positif</h2>
    </div>
    <p class="text-lg leading-relaxed text-justify mb-6">
      Hasil kegiatan mencakup peningkatan dari 66 indukan menjadi 11.437 anakan karang, diversifikasi produk untuk ekspor, pengurangan eksploitasi alam, dan peningkatan kesejahteraan nelayan. Program ini menjadi model budidaya berkelanjutan di wilayah pesisir lainnya.
    </p>
    ...
    <p class="text-lg leading-relaxed text-justify">
      Baca selengkapnya:
      <a href="https://journal.unhas.ac.id/index.php/panritaabdi/article/download/13893/6991/48017" target="_blank" class="text-blue-600 hover:underline hover:text-blue-800 transition">
        PPPUD: Budidaya Karang Hias Berbasis Masyarakat di Pulau Barrang Lompo
      </a>
    </p>
  </div>
</main>
